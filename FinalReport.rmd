...
```{r}
table2=xtabs(~infected + treatment  , data=LBGTguys)
rowPerc(table2)
colPerc(table2)
```
...
```{r}
table3=xtabs(~infected + treatment  , data=men)
rowPerc(table3)
colPerc(table3)
```
...
```{r}
table4=xtabs(~infected + treatment  , data=women)
rowPerc(table4)
colPerc(table4)
```
...
```{r}
table5=xtabs(~infected + treatment  , data=DrugUser)
rowPerc(table5)
colPerc(table5)
```
